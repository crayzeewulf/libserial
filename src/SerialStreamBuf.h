...
namespace LibSerial 
{
    ...
    public:
        ...
        /// 
        /// Initialize the serial communication parameters to their default
        /// values.
        ///
        ...
        ///
        /// Get the curent parity setting for the serial port. 
        ///
        /// @return The paritty setting for the serial port. 
