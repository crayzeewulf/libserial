...
extern "C++" {
  namespace LibSerial {
     ...
     *  serial port can be set. Several features of this streambuf
     *  class resemble those of std::filebuf, however this class it
     *  not made a subclass of filebuf because we need access to the
     *  file descriptor associated with the serial port and the
     *  standard filebuf does not provide access to it.
     *
